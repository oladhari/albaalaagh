...
ملاحظة: "المصدر" أعلاه هو معلومة داخلية للسياق فقط. لا تذكر اسم الوسيلة الإعلامية أو الجهة التي نقلت الخبر داخل نص التقرير (مثلاً: لا تكتب "نقلته إذاعة..." أو "بحسب موقع..."). اكتب الوقائع مباشرة كمعلومة متاحة للعموم. إن كان هناك تصريح أو بيان رسمي، انسبه إلى الجهة صاحبة الشأن نفسها (مثل الوزارة أو المؤسسة المعنية)، لا إلى الوسيلة الإعلامية التي نقلت عنها.`;
