...
- لا تذكر اسم الوسيلة الإعلامية أو الموقع الذي نقل الخبر (حتى لو ورد ذلك في المحتوى الأصلي أدناه) — اكتب الوقائع مباشرة كمعلومة متاحة للعموم، وانسب أي تصريح أو بيان إلى الجهة صاحبة الشأن نفسها لا إلى من نقل عنها
