...
export default function EditWriterPage() {
  ...
  if (loading) {
    return <div className="text-center py-20" style={{ color: "#9A9070" }}>جارٍ التحميل...</div>;
  }

  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-black mb-8" style={{ color: "#F0EAD6" }}>تعديل الكاتب</h1>
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="اكتب نبذة مختصرة عن الكاتب..."
            value={form.bio}
